...
from Simulation.vessel_sim_engine import Waypoint,Destination,Mission,vesselFuel,vesselBase,Simulation
import copy
#file paths
...
from Simulation.vessel_sim_engine import (
    Waypoint, Destination, Mission,
    vesselFuel, vesselBase, Simulation
)
...
if __name__ == "__main__":
    ...
    simulation_tasks = [
        ...
        'vessels': [
            {'name':'vessel1_ml',
             ...
             'start_obj':Destination(Waypoint(40,-139),datetime(2024, 12, 20, 0, 0),0),
             'end_obj': Destination(Waypoint(40,-139),datetime(2024, 12, 24, 7, 0),0),
            ...
            {'name':'vessel3_ml',
             'vessel_class': vesselFuel,
             'start_obj':  Destination(Waypoint(36,155),datetime(2024, 12, 20, 0, 0),0),
             'end_obj':  Destination(Waypoint(36,155),datetime(2024, 12, 24, 7, 0),0),
            ...
            {'name':'vessel4_ml',
             'vessel_class': vesselFuel,
             'start_obj':  Destination(Waypoint(35,155),datetime(2024, 12, 20, 0, 0),0),
             'end_obj':  Destination(Waypoint(35,155),datetime(2024, 12, 24, 7, 0),0),
    ...
    {   
        ...
        'vessels': [
            {'name':'vessel1_ml',
             'vessel_class': vesselFuel,
             'start_obj':Destination(Waypoint(40,-139),datetime(2024, 12, 21, 0, 0),0),
             'end_obj': Destination(Waypoint(40,-139),datetime(2024, 12, 24, 7, 0),0),
             'mission_destinations': destinations1_ml,
             'weather_input_dir':weath_input_dir_lat40_lon_neg_140,
             'model_path': model_path,
            ...
            {'name':'vessel3_ml',
             'vessel_class': vesselFuel,
             'start_obj':  Destination(Waypoint(36,155),datetime(2024, 12, 21, 0, 0),0),
             'end_obj':  Destination(Waypoint(36,155),datetime(2024, 12, 24, 7, 0),0),
             'mission_destinations': destinations3_ml,
             'weather_input_dir':weath_input_dir_lat35_lon155,
             'model_path': model_path,
            ...
            {'name':'vessel4_ml',
             'vessel_class': vesselFuel,
             'start_obj':  Destination(Waypoint(35,155),datetime(2024, 12, 21, 0, 0),0),
             'end_obj':  Destination(Waypoint(35,155),datetime(2024, 12, 24, 7, 0),0),
             'mission_destinations': destinations4_ml,
             'weather_input_dir':weath_input_dir_lat35_lon155,
             'model_path': model_path,
