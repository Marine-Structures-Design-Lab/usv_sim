...
from Simulation.vessel_sim_engine import Waypoint, Mission,Destination,vesselFuel,Simulation
...
def run_sim_engine():
 ...
 vessel_fc_test1=vesselFuel("vessel1","sim1", Destination(Waypoint(38.1,-139),datetime(2024, 12, 20, 0, 0),0),Destination(Waypoint(38.1,-139),datetime(2024, 12, 24, 7, 0),0), fc_test_mission1, 50,weath_input_dir_lat40_lon_neg_140,fc_input_dir=fc_input_dir_lat40_lon_neg_140
