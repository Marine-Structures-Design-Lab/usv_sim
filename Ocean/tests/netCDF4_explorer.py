...
# 1. Open .nc files
ds = Dataset("Ocean/tests/weather_2_nc/0101_0110_lat-5_5_lon270_280_fc50_ts9/gfsWave_Global25_20250101_00_000.nc", AccessMode = "r")
...
for name, var in ds.variables.items():
    print(f"  {name}: shape = {var.shape}, dtype = {var.datatype}, unit = {getattr(var, 'units', 'N/A')}")
