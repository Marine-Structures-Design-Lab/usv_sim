...
class DatabaseManager:
    ...
    def insert_vessel(
        self, name, sim_name, vessel_type, capacity, system_health, fuel_level
    ):
        """
        Summary
        ------------------------------------------------------------
    ...
    def insert_mission_waypoint(
        self, mission_id, waypoint_id, replan_id, waypoint_order, goal_time, est_time
    ):
        """
        Summary
        -----------------------------------------------------------
