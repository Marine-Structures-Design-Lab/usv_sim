...
def test_extract_date_from_filename_valid():
    assert downsizer.extract_date_from_filename("gfsWave_Global25_20241117_00_024.grib2") == dt.datetime(2024, 11, 17)

def test_extract_date_from_filename_invalid_format():
    assert downsizer.extract_date_from_filename("gfsWave_Global25_2024-11-17_00_024.grib2") is None

def test_extract_date_from_filename_no_date():
    assert downsizer.extract_date_from_filename("gfsWave_Global25_nodate_00_024.grib2") is None

# extract_forecast_hour_from_filename tests
def test_extract_forecast_hour_from_filename_valid():
    assert downsizer.extract_forecast_hour_from_filename("gfsWave_Global25_20241117_00_024.grib2") == 24

def test_extract_forecast_hour_from_filename_invalid():
    assert downsizer.extract_forecast_hour_from_filename("gfsWave_Global25_20241117_00_ABC.grib2") is None

def test_extract_forecast_hour_from_filename_middle_invalid():
    assert downsizer.extract_forecast_hour_from_filename("gfsWave_Global25_20241117_002_ABC.grib2") is None

def test_extract_forecast_hour_from_filename_missing():
    assert downsizer.extract_forecast_hour_from_filename("gfsWave_Global25_2024-11-17_00.grib2") is None
