...
def test_filter_files_by_issue_time_earlier_issue_dt():
    ...
    metadata = [
        make_entry("file1.nc", dt.datetime(2024, 12, 5, 6), dt.datetime(2024, 12, 5, 9)),
        make_entry("file2.nc", dt.datetime(2024, 12, 5, 9), dt.datetime(2024, 12, 5, 15)),
    ]
...
def test_filter_exact_match_included():
    current_dt = dt.datetime(2024, 12, 5, 12)
    metadata = [
        make_entry("file1.nc", dt.datetime(2024, 12, 5, 12), dt.datetime(2024, 12, 5, 12)),
        make_entry("file1.nc", dt.datetime(2024, 12, 5, 12), dt.datetime(2024, 12, 5, 15)),
    ]
    result = interpolator.filter_files_by_issue_time(metadata, current_dt)
...
def test_filter_some_entries_filtered():
    current_dt = dt.datetime(2024, 12, 5, 12)
    metadata = [
        make_entry("file1.nc", dt.datetime(2024, 12, 5, 6), dt.datetime(2024, 12, 5, 15)),
        make_entry("file2.nc", dt.datetime(2024, 12, 5, 12), dt.datetime(2024, 12, 5, 15)),
        make_entry("file3.nc", dt.datetime(2024, 12, 5, 15), dt.datetime(2024, 12, 5, 15)),
    ]
    result = interpolator.filter_files_by_issue_time(metadata, current_dt)
    expected = [
        make_entry("file2.nc", dt.datetime(2024, 12, 5, 12), dt.datetime(2024, 12, 5, 15)),
...
def test_filter_all_entries_filtered():
    current_dt = dt.datetime(2024, 12, 5, 12)
    metadata = [
        make_entry("file1.nc", dt.datetime(2024, 12, 8, 6), dt.datetime(2024, 12, 8, 9)),
        make_entry("file2.nc", dt.datetime(2024, 12, 8, 12), dt.datetime(2024, 12, 8, 15)),
    ]
    result = interpolator.filter_files_by_issue_time(metadata, current_dt)
    assert result == []
...
def test_find_time_bounds_found_between_entries():
    metadata = [
        make_entry("file1.nc", dt.datetime(2024, 12, 5, 6), dt.datetime(2024, 12, 5, 9)),
        make_entry("file2.nc", dt.datetime(2024, 12, 5, 6), dt.datetime(2024, 12, 5, 12)),
    ]
...
@pytest.mark.parametrize("lat_idx, lon_idx", [
...
def test_interpolate_spatial_value_center_point(basic_grid):
    ...
    target_lat = 10.5
    target_lon = 100.5
    corners, weights = interpolator.get_spatial_weights(lats, lons, target_lat, target_lon)
